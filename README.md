...
2. This is the login page. Email and password are the required fields to log in.
![Login](https://github.com/josesison1/Project-Step-6-UI-UX/blob/master/2.png)

3. This is the registration page with the required fields to create an account.
