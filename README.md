...
|-------|--------|--------------|------|---------------|
|TID1|1.0, 1.1, 1.2, 1.3|Ensure register is properly working when clicked and user enters correct format on all fields|Not Tested|N/A|
|TID5|2.0, 2.1, 2.2|Ensure error message is displayed once user reach maximum login attempts|Not Tested|N/A|
|TID8|3.0, 3.1|Ensure the system calculates the prices of rental length once selected by user|Not Tested|N/A|
|TID10|4.0, 4.1|Ensure the system generates an automated message to the listing user once "Rent Now" button is clicked|Not Tested|N/A|
